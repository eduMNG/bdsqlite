...
import com.edu.bdsqlite.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonUpdate.setOnClickListener {
            if (pos >= 0) {
                ...
                if (res > 0) {
                    Toast.makeText(applicationContext, "Update Ok : $res", Toast.LENGTH_SHORT)
                        .show()
        ...
        binding.buttonDelete.setOnClickListener {
            if(pos >= 0) {
                ...
                if (res > 0) {
                    Toast.makeText(applicationContext, "Delete Ok : $res", Toast.LENGTH_SHORT)
                        .show()
                    listaUtilizadores.removeAt(id)
                    adapter.notifyDataSetChanged()
                } else {
                    Toast.makeText(applicationContext, "Delete Failed : $res", Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
